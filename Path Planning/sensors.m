...
%    wd      = uu(24);
    ...
    % simulate pressure sensors
    sigma_static_pres = 0.01*1000; % standard deviation of static pressure sensor in Pascals
    sigma_diff_pres = 0.002*1000;  % standard deviation of diff pressure sensor in Pascals
    
    y_static_pres = P.rho*P.gravity*(-pd) + sigma_static_pres*randn;
    y_diff_pres = 0.5*P.rho*Va^2 + sigma_diff_pres*randn;
